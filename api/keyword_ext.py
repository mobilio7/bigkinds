...
# DB에서 news data 가져온뒤 본문내용 input_txt에 담기
input_txt = '''
'''

tagger = Tagger()

tokenized_doc = tagger.pos(input_txt)
...
model = SentenceTransformer('/home/user/test/kpfSBERT/output/kpfSBERT') # 모델위치는 향후 디렉토리 보고 변경
doc_embedding = model.encode([input_txt])
